 ...
 * 2017-08-20T14:57:07.110+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "UserServiceImplService", 
                  wsdlLocation = "http://localhost:8080/services/UserService?wsdl",
                  targetNamespace = "http://user.webservice.yelr.com/") 
public class UserServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://user.webservice.yelr.com/", "UserServiceImplService");
    public final static QName UserServicePort = new QName("http://user.webservice.yelr.com/", "UserServicePort");
    static {
        URL url = null;
        try {
