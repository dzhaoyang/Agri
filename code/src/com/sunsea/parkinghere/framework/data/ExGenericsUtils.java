...
public final class ExGenericsUtils {
	/**
	 * 通过反射,获得指定类的父类的泛型参数的实际类型. <br>
	 * 如:AServiceBean extends ASupport<C>
	 * 
	 * @param clazz
	...
	public static Class<?> getSuperClassGenricType(Class<?> clazz, int index) {
		...
		if (index >= params.length || index < 0) {
			throw new InternalException("你输入的索引" + (index < 0 ? "不能小于0" : "超出了参数的总数"));
		}
	...
	/**
	 * 通过反射,获得方法输入参数第index个输入参数的所有泛型参数的实际类型. 如: public void add(Map<String, Buyer>
