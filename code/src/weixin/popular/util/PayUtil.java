...
public class PayUtil {
    ...
    public static String generatePayJsRequestJson(PayPackage payPackage,
        ...
        try {
            return objectMapper.writeValueAsString(generatePayJsRequest(payPackage,
                                                                        appId,
                                                                        paternerKey,
                                                                        paySignkey));
        }
     ...
     * @return
     */
    public static PayNativeRequest generatePayNativeRequest(String appid,
                                                            String productid,
                                                            String paySignkey) {
     ...
     * @return
     */
    public static String generatePayNativeRequestURL(String appid,
                                                     String productid,
                                                     String paySignkey) {
        PayNativeRequest payNativeRequest = generatePayNativeRequest(appid,
                                                                     productid,
                                                                     paySignkey);
    ...
    public static PayNativeReply generatePayNativeReply(PayPackage payPackage,
        ...
        String appSignature = SignatureUtil.generatePackage(MapUtil.objectToMap(payNativeReply,
                                                                                "appsignature",
                                                                                "signmethod"),
                                                            paternerKey);
    ...
    public static String generatePayNativeReplyXML(PayPackage payPackage,
                                                   ...
                                                   String retErrMsg,
                                                   String paternerKey) {
        PayNativeReply payNativeReply = generatePayNativeReply(payPackage,
                                                               appId,
                                                               retCode,
                                                               retErrMsg,
                                                               paternerKey);
