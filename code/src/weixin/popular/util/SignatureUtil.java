...
public class SignatureUtil {
    ...
    public static boolean validateAppSignature(PayFeedback payFeedback,
        ...
        Map<String, String> map = MapUtil.objectToMap(payFeedback,
                                                      ...
                                                      "solution",
                                                      "extinfo");
        return payFeedback.getAppsignature()
                          .equals(generatePaySign(map, paySignKey));
    }
    ...
    public static boolean validateAppSignature(PayNativeInput payNativeInput,
        ...
        Map<String, String> map = MapUtil.objectToMap(payNativeInput,
                                                      "appsignature",
                                                      "signmethod");
        return payNativeInput.getAppsignature()
                             .equals(generatePaySign(map, paySignKey));
    }
    ...
    public static boolean validateAppSignature(PayNotify payNotify,
        ...
        Map<String, String> map = MapUtil.objectToMap(payNotify,
                                                      "appsignature",
                                                      "singmethod");
        return payNotify.getAppsignature().equals(generatePaySign(map,
                                                                  paySignKey));
    }
    ...
    public static boolean validateAppSignature(PayWarn payWarn,
                                               String paySignKey) {
        Map<String, String> map = MapUtil.objectToMap(payWarn,
                                                      "appsignature",
                                                      "signmethod");
        return payWarn.getAppsignature()
                      .equals(generatePaySign(map, paySignKey));
    }
