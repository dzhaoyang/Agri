...
public class MenuAPI extends BaseAPI {
    ...
    public BaseResult menuCreate(String access_token, String menuJson) {
        ...
        HttpEntity<String> httpEntity = new HttpEntity<String>(menuJson,
                                                               headers);
        ResponseEntity<BaseResult> responseEntity = super.restTemplate.exchange(BASE_URI + "/cgi-bin/menu/create?access_token={access_token}",
                                                                                HttpMethod.POST,
                                                                                httpEntity,
                                                                                BaseResult.class,
                                                                                access_token);
    ...
    public Menu menuGet(String access_token) {
        return super.restTemplate.postForObject(BASE_URI + "/cgi-bin/menu/get?access_token={access_token}",
                                                null,
                                                Menu.class,
                                                access_token);
    }
    ...
    public BaseResult menuDelete(String access_token) {
        return super.restTemplate.postForObject(BASE_URI + "/cgi-bin/menu/delete?access_token={access_token}",
                                                null,
                                                BaseResult.class,
                                                access_token);
    }
