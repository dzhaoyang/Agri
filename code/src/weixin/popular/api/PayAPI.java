...
public class PayAPI extends BaseAPI {
     ...
     * @return
     */
    private BaseResult payDelivernotify(String access_token,
                                        String delivernotifyJson) {
        MediaType mediaType = new MediaType("application",
                                            "json",
                                            Charset.forName("UTF-8"));
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(mediaType);
        HttpEntity<String> httpEntity = new HttpEntity<String>(delivernotifyJson,
                                                               headers);
        ResponseEntity<BaseResult> responseEntity = super.restTemplate.exchange(BASE_URI + "/pay/delivernotify?access_token={access_token}",
                                                                                HttpMethod.POST,
                                                                                httpEntity,
                                                                                BaseResult.class,
                                                                                access_token);
     ...
     * @return
     */
    public BaseResult payfeedbackUpdate(String access_token,
                                        String openid,
                                        String feedbackid) {
    ...
    private OrderInfo payOrderquery(String access_token, String orderqueryJson) {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(mediaType);
        HttpEntity<String> httpEntity = new HttpEntity<String>(orderqueryJson,
                                                               headers);
        ResponseEntity<OrderInfo> responseEntity = super.restTemplate.exchange(BASE_URI + "/pay/orderquery?access_token={access_token}",
                                                                               HttpMethod.POST,
                                                                               httpEntity,
                                                                               OrderInfo.class,
                                                                               access_token);
     ...
     * @return
     */
    public BaseResult payDelivernotify(String access_token,
        ...
        try {
            return payDelivernotify(access_token,
     ...
     * @return
     */
    public OrderInfo payOrderquery(String access_token,
        ...
        String packAge = SignatureUtil.generatePackage(tmap,
                                                       orderquery.getPartner_key());
        // builder package end
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            return payOrderquery(access_token,
                                 objectMapper.writeValueAsString(map));
        }
        catch (JsonProcessingException e) {
            e.printStackTrace();
