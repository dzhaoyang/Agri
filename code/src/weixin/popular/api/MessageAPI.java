...
public class MessageAPI extends BaseAPI {
	...
	public BaseResult messageCustomSend(String access_token, String messageJson) {
		...
		HttpEntity<String> httpEntity = new HttpEntity<String>(messageJson,
				headers);
		ResponseEntity<BaseResult> responseEntity = super.restTemplate
				.exchange(
						BASE_URI
								+ "/cgi-bin/message/custom/send?access_token={access_token}",
						HttpMethod.POST, httpEntity, BaseResult.class,
						access_token);
