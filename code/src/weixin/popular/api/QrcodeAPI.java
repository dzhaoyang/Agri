...
public class QrcodeAPI extends BaseAPI {
    ...
    private QrcodeTicket qrcodeCreate(String access_token, String qrcodeJson) {
        ...
        HttpEntity<String> httpEntity = new HttpEntity<String>(qrcodeJson,
                                                               headers);
        ResponseEntity<QrcodeTicket> responseEntity = super.restTemplate.exchange(BASE_URI + "/cgi-bin/qrcode/create?access_token={access_token}",
                                                                                  HttpMethod.POST,
                                                                                  httpEntity,
                                                                                  QrcodeTicket.class,
                                                                                  access_token);
    ...
    private QrcodeTicket qrcodeCreate(String access_token,
                                      ...
                                      String action_name,
                                      long scene_id) {
        return qrcodeCreate(access_token,
                            String.format("{"     + (expire_seconds == null ? "%1$s"
                                                                           : "\"expire_seconds\": %1$s, ")
