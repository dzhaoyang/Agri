...
public class RefundInput {
    ...
    private String transaction_id; // 财付通交易号，28 位长的数值，其中前10 位为商户号，之后8
    ...
    private Integer refund_status; /*
                                    * 退款状态： 4，10：退款成功。 3，5，6：退款失败。 8，9，11：退款处理中。
                                    * 1，2：未确定，需要商户原退款单号重新发起。
                                    * 7：转入代发，退款到银行发现用户的卡作废或 者冻结了，导致原路退款银行卡失败，资金回
                                    * 流到商户的现金帐号，需要商户人工干预，通 过线下或者财付通转账的方式进行退款。
                                    */
