...
if (!window['google']['loader']) {
	...
	(function() {
		...
		google[A].d = function(a, b, c) {
			if (c) {
				...
				(a = o.getElementsByTagName("head")[0])
						|| (a = o.body.parentNode.appendChild(o
								.createElement("head")));
				a.appendChild(e)
			} else if (a == "script")
				o.write('<script src="' + b
		...
		google[A].K = function() {
			return "qid="
					+ ((new Date)[w]().toString(16) + Math.floor(
							Math.random() * 1E7).toString(16))
		};
		...
		google[A].b.A = "//www.google.com/cse/style/look/bubblegum.css";
		M(google[A].b, "BUBBLEGUM", google[A].b.A);
		google[A].b.C = "//www.google.com/cse/style/look/greensky.css";
		M(google[A].b, "GREENSKY", google[A].b.C);
		google[A].b.B = "//www.google.com/cse/style/look/espresso.css";
		M(google[A].b, "ESPRESSO", google[A].b.B);
		google[A].b.F = "//www.google.com/cse/style/look/shiny.css";
		M(google[A].b, "SHINY", google[A].b.F);
		google[A].b.D = "//www.google.com/cse/style/look/minimalist.css";
		...
		p(V[y], function(a, b) {
			...
			if (c[x]) {
				...
				if (!b && O[":" + this.a] != g
						&& O[":" + this.a].versions[":" + a] != g
						&& !google[A].AdditionalParams && this.l) {
					c = O[":" + this.a];
		...
		var Y = function(a, b) {
			return a.string ? j(a.string) + "=" + j(b) : a.regex ? b[r](
					/(^.*$)/, a.regex) : ""
		};
		W[y].g = function(a, b) {
		...
		W[y].M = function(a, b, c) {
			...
			if (c != g)
				for ( var f in c)
					if (a.params[f])
						e += "&" + Y(a.params[f], c[f]);
					else if (f == "other_params")
						e += "&" + c[f];
					else if (f == "base_domain")
						b = "http://" + c[f] + a.uri[B](a.uri[t]("/", 7));
			google[this[v]] = {};
			if (b[t]("?") == -1 && e)
				e = "?" + e[B](1);
			return b + e
		...
		var da = h, Z = [], ea = (new Date)[w](), ca = function(a, b, c) {
			...
			if (c) {
				if (!google[A].Secure
						&& (!google[A].Options || google[A].Options.csi === h)) {
					a = a[D]()[r](/[^a-z0-9_.]+/g, "_");
					b = b[D]()[r](/[^a-z0-9_.]+/g, "_");
					l[z](H($, g, "//gg.google.com/csi?s=uds&v=2&action=" + j(a)
							+ "&it=" + j(b)), 1E4)
				}
			} else {
				Z[q]("r" + Z[x] + "=" + j(a + (b ? "|" + b : "")));
	...
	google.loader.rfm({
		":search" : {
			...
			"path" : "/api/search/1.0/437b95d3a8c1fa64e02a22efdaa67deb/",
			"js" : "default+zh_CN.I.js",
			"css" : "default.css",
			"properties" : {
				":JSHash" : "437b95d3a8c1fa64e02a22efdaa67deb",
				":NoOldNames" : false,
				":Version" : "1.0"
			}
		},
		":language" : {
			...
			"path" : "/api/language/1.0/ce705c2ec5ef0c84a8e286708911fd7c/",
			"js" : "default+zh_CN.I.js",
			"properties" : {
				":JSHash" : "ce705c2ec5ef0c84a8e286708911fd7c",
				":Version" : "1.0"
			}
		},
		":feeds" : {
			...
			"path" : "/api/feeds/1.0/846e46c01473dff1e4e1e29d71ad1d50/",
			"js" : "default+zh_CN.I.js",
			"css" : "default.css",
			"properties" : {
				":JSHash" : "846e46c01473dff1e4e1e29d71ad1d50",
				":Version" : "1.0"
			}
		},
		":spreadsheets" : {
		...
		":annotations" : {
			...
			"path" : "/api/annotations/1.0/f3e1a43a6723a6b305a0e9fc4f907cf6/",
			"js" : "default+en.I.js",
			"properties" : {
				":JSHash" : "f3e1a43a6723a6b305a0e9fc4f907cf6",
				":Version" : "1.0"
			}
		},
		":earth" : {
