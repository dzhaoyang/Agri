...
<html>
	...
	<body style="background-color: white;margin: 0px;padding: 0px;">
		...
		<div id="page${totalImgCount}" style="width: 100%;text-align: center;margin: 0px;padding: 0px;z-index: 3;position: fixed;">
			<button id="button" class="btn" style="background-color: rgba(255, 255, 255, 0.34);color: red;font-weight: 700;font-size: large;margin-left: auto;margin-right: auto;">我 要 抽 奖</button>
...
$(document).ready(function () {
	...
	if($('#isCan').val()=='true'){
		...
		$('#button').css('margin-top',scrollHeight*0.8);
