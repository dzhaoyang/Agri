		...
		<div id="info_div" style="width: 100%;text-align: center;z-index: 3;position: fixed;">
			<div style="margin-left: auto;margin-right: auto;">
				...
				<div style="width: 100%;text-align: left;">
					<div>${instruction}</div>
					<div>请耐心填写您的个人信息，并点击提交按钮。</div>
				</div>
				<div style="width: 100%;height: 10px"></div>
				<div style="width: 100%;text-align: left;">
					<input type="number" id="phone" name="phone" placeholder="请输入手机号" style="width: 100%;height: 40px;background-color: rgba(255, 255, 255, 0.34);" value="${phone}">
				</div>
				...
				<div style="width: 100%;height: 5px"></div>
				<div style="width: 100%;text-align: left;">
					<input type="number" id="age" name="age" placeholder="请输入你的年龄" style="width: 100%;height: 40px;background-color: rgba(255, 255, 255, 0.34);"  value="${age}">
				</div>
				</form>
			</div>
		</div>
		<div id="button_div" style="width: 100%;text-align: center;margin: 0px;padding: 0px;z-index: 3;position: fixed;">
			<button id="button1" class="btn" style="color: red;padding: 10px 10px;">提  交</button>
			<div style="height: 10px"></div>
			<button id="button2" class="btn" style="color: black;padding: 10px 10px;">放  弃</button>
...
$(document).ready(function () {
	...
	$('#info_div').css('margin-top',scrollHeight*0.05);
