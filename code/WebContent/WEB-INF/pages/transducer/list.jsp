...
<template:identity pageTitle="传感器管理-传感器列表">
    <template:panel title="传感器列表 <span id='recordSize' class='small-text'></span>" customBody="true">
		<jsp:attribute name="titlebtns">
			<template:panelTitleForm>
                ...
                <template:panelTitleBtn href="/transducer/new" icon="plus" label="新增"></template:panelTitleBtn>
		...
		<jsp:attribute name="body">
			...
			<table id="dataContainer" class="table table-bordered  table-striped">
                ...
                <tr>
                    ...
                    <th style="text-align: center;width: 10%;">是否自动</th>
...
<script type="text/javascript" src="/js/dashboard/transducer.js?sjs=3"></script>
<script type="text/javascript">
    <!--
    $(document).ready(function () {
        dashboard.transducer.list.init();
    });
    //-->
</script>