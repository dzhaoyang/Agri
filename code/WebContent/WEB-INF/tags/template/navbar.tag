...
<div class="navbar-default navbar-menu">
    <div class="container">
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav" id="_navBar_">
                <li><a href="<c:url value="/sso/portals/list.do"/>">Portal</a></li>
                <li><a href="<c:url value="/sso/manager/sites/list.do"/>">SSO Service</a></li>
                <li><a href="<c:url value="/auth/2faas/settings.do"/>">2Factor Service</a></li>
                <li><a href="<c:url value="/managerconsole/identity.do"/>">Identity Console</a></li>
                <li><a href="<c:url value="/managerconsole/tenant.do"/>">Tenant Console</a></li>
                <li><a href="<c:url value="/managerconsole/admin.do"/>">Admin Console</a></li>
            </ul>
        </div>
        <!--/.nav-collapse -->
    </div>
