...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#oauthNav li").eq(oathIndex).addClass("active");
    ...
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="col-lg-3">
            <div class="panel panel-default">
                ...
                <ul id="oauthNav" class="nav nav-pills nav-stacked">
                    <li><a href="<c:url value="/oauth2/client/list.do"/>">Remote Client</a></li>
                    <li><a href="<c:url value="/oauth2/token/list.do"/>">Token Manager</a></li>
                </ul>
            </div>
        </div>
    </div>
